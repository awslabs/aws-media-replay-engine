...
def main(region, profile=None):
    ...
    amplify_app_id = cdk_outputs_json["live-news-segmenter-frontend-stack"]["webAppId"]
    user_pool_id = cdk_outputs_json["live-news-segmenter-frontend-stack"]["userPoolId"]
    identity_pool_id = cdk_outputs_json["live-news-segmenter-frontend-stack"][
        "identityPoolId"
    ]
    app_client_id = cdk_outputs_json["live-news-segmenter-frontend-stack"][
        "appClientId"
    ]
    web_url = cdk_outputs_json["live-news-segmenter-frontend-stack"]["webAppURL"]
    ...
    search_streaming_endpoint = ssm_client.get_parameter(
        Name="/MRE/Search/EndpointURL", WithDecryption=False
    )["Parameter"]["Value"]
    ...
    amplify_client.update_app(
        ...
        environmentVariables={
            "VITE_CONTROL_PLANE_ENDPOINT": control_plain_endpoint["Parameter"]["Value"],
