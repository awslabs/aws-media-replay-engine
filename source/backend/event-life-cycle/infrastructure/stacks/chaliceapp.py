...
class ChaliceApp(Stack):
    ...
    def __init__(self, scope, id, **kwargs):
        ...
        self.environment_config = {"EB_EVENT_BUS_NAME": self.event_bus.event_bus_name}
        ...
        self.schedule_purger_handler_lambda = _lambda.Function(
            self,
            "SchedulePurgerHandler",
            code=_lambda.Code.from_asset(
                f"{RUNTIME_SOURCE_DIR}/lambda",
        ...
        self.schedule_cleanup_cron_rule = events.Rule(
            self,
            "ScheduleCleanupCronRule",
            ...
            targets=[
                events_targets.LambdaFunction(handler=self.schedule_cleanup_cron_lambda)
            ],
        ...
        self.medialive_eb_schedule_rule = events.Rule(
            ...
            event_pattern=events.EventPattern(
                source=["awsmre"], detail={"State": ["VOD_EVENT_END", "LIVE_EVENT_END"]}
            ),
            targets=[
                events_targets.LambdaFunction(
        ...
        self.eb_schedule_deletion_rule = events.Rule(
            ...
            event_pattern=events.EventPattern(
                source=["awsmre"],
                detail={"State": ["VOD_EVENT_COMPLETE", "LIVE_EVENT_COMPLETE"]},
            ),
            targets=[
                events_targets.LambdaFunction(
        ...
        self.channel_starter_eb_rule = events.Rule(
            ...
            event_bus=self.event_bus,
            event_pattern=events.EventPattern(
                source=["awsmre"], detail={"State": ["LIVE_EVENT_START"]}
            ),
            targets=[
                events_targets.LambdaFunction(
        ...
        NagSuppressions.add_stack_suppressions(
            ...
            [
                ...
                {
                    "id": "AwsSolutions-IAM5",
                    "reason": "Access required to MRE SSM parameters for configuration",
                    "appliesTo": [
                ...
                {
                    "id": "AwsSolutions-IAM5",
                    "reason": "EventBridge permissions needed for custom event bus",
                    "appliesTo": [
                ...
                {
                    "id": "AwsSolutions-IAM5",
                    "reason": "API Gateway execute permissions required",
                    "appliesTo": [
                ...
                {
                    "id": "AwsSolutions-IAM5",
                    "reason": "MediaLive channel access required for event processing",
                    "appliesTo": [
                ...
                {
                    "id": "AwsSolutions-IAM5",
                    "reason": "EventBridge scheduler permissions needed for MRE schedules",
                    "appliesTo": [
                ...
                {
                    "id": "AwsSolutions-IAM5",
                    "reason": "Wildcard permission required for ListSchedules action",
                    "appliesTo": ["Resource::*"],
                },
                {
                    "id": "AwsSolutions-IAM5",
                    "reason": "S3 bucket access required for MRE assets",
                    "appliesTo": [
                        {
