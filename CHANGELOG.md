...
### Fixed
    - Issue#61 - Cloudformation stack "mre-prompt-catalog-table-arn" doesnot get exported
    - Issue#72 - PROMPT_CATALOG_URL added to environment variables even when GENERATIVE_AI flag is disabled
