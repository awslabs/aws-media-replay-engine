export const environments = {
  ...
  API_REPLAY: import.meta.env.VITE_CONTROL_PLANE_ENDPOINT.replace(/\/$/, ''),
  API_PROFILE: import.meta.env.VITE_CONTROL_PLANE_ENDPOINT.replace(/\/$/, ''),
  API_THEME: import.meta.env.VITE_LIVE_NEWS_SEGMENTER_ENDPOINT + 'samples/news',
  ...
  APP_CLOUDFRONT_DOMAIN: import.meta.env.VITE_CLOUDFRONT_DOMAIN_NAME,
};
