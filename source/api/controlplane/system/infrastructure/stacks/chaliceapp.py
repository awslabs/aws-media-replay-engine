...
class ChaliceApp(cdk.Stack):
    ...
    def __init__(self, scope, id, **kwargs):
        ...
        self.system_table_arn = cdk.Fn.import_value("mre-system-table-arn")
        self.system_table_name = cdk.Fn.import_value("mre-system-table-name")
    ...
    def create_chalice_role(self):
        ...
        cdk.CfnOutput(self, "mre-system-api-url", value=self.chalice.sam_template.get_output("EndpointURL").value, description="MRE System API Url", export_name="mre-system-api-url" )
