    ...
    def create_chalice_role(self):
        ...
        self.chalice_role.add_to_policy(
            iam.PolicyStatement(
                ...
                resources=[self.workflow_exec_table_arn],
            )
        )
        ...
        NagSuppressions.add_stack_suppressions(
            ...
            [
                ...
                },
                {
                    ...
                    "appliesTo": ["Resource::<WorkflowApiEnableLoggingHandlerDBE9A39D.Arn>:*"]
                }
            ],
        )
        ...
        CfnOutput(
            self,
            "mre-workflow-api-url",
            value=self.chalice.sam_template.get_output("EndpointURL").value,
            description="MRE Workflow API Url",
            export_name="mre-workflow-api-url",
        )
