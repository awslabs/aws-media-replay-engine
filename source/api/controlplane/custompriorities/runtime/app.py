...
def create_custom_priorities_engine():
    """
    Create a new Custom Prioriies Engine. A Custom Priorities Engine is a collection of attributes
    that define the API that provides segment level significance during replay generation
    ...
    Parameters:
        ...
        - Name: Name of the Custom Priorities Engine
        - Description: Description of the Custom Priorities Engine
...
def list_custompriorities():
    """
    List all the custom priorities engines.
...
def get_custompriorities(name):
    """
    Get a custom priorities engine by name.
...
def update_custom_priorities_engine(name):
    """
    Update a custom priorities engine by name.
...
def delete_custom_priorities_engine(name):
    """
    Delete a custom priorities engine by name.
