...
class ESReplayDataExporter:
    ...
    def _get_all_segments_for_event(self):
        base_replay_data_export_loc = self._event['detail']['Event']['ReplayExportS3Location']
        s3_prefix_parts = base_replay_data_export_loc.split('/')
    ...
    def _build_segments_for_event(self):
        ...
        "Segments": [
            {
                ...
                "FeaturesFound": [
                    {
                    "AttribName": "BreakPoint",
                    "PluginName": "TennisScoreExtraction",
                    "AttribValue": "True",
                    "Weight": 100.0,
                    "Name": "TennisScoreExtraction - BreakPoint - True"
                    }
                ]
            }
        ]
        ...
        for segment in segments_payload:
            if 'FeaturesFound' in segment:
                for feature in segment['FeaturesFound']:
                    seg = {}
                    seg['EventType'] = self._get_event_type(feature['AttribName'])
    ...
    def generate_replay_data(self):
        ...
        event_data_export["aws:mre"]["Replay"] = replay
