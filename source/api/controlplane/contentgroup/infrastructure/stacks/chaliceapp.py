...
class ChaliceApp(Stack):
    ...
    def __init__(self, scope, id, **kwargs):
        ...
        api_logging_construct.ApiGatewayLogging(
            self, 
            "ContentGroupApiGatewayLogging3",
    ...
    def create_chalice_role(self):
        ...
        self.chalice_role.add_to_policy(
            iam.PolicyStatement(
                ...
                resources=[self.content_group_table_arn],
            )
        )
        ...
        NagSuppressions.add_stack_suppressions(
            ...
            [
                ...
                },
                {
                    ...
                    "appliesTo": ["Resource::<ContentGroupApiGatewayLogging3EnableLoggingHandlerAEC8DA9E.Arn>:*"]
                }
        ...
        CfnOutput(
            self,
            "mre-contentgroup-api-url",
            value=self.chalice.sam_template.get_output("EndpointURL").value,
            description="MRE Content Group API Url",
            export_name="mre-contentgroup-api-url",
        )
