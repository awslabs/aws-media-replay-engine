...
class ChaliceApp(cdk.Stack):
    ...
    def create_chalice_role(self):
        ...
        cdk.CfnOutput(self, "mre-plugin-api-url", value=self.chalice.sam_template.get_output("EndpointURL").value, description="MRE Plugin API Url", export_name="mre-plugin-api-url" )
