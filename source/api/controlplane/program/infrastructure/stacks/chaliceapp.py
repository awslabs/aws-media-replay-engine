...
class ChaliceApp(cdk.Stack):
    ...
    def __init__(self, scope, id, **kwargs):
        ...
        self.program_table_arn = cdk.Fn.import_value("mre-program-table-arn")
        self.program_table_name = cdk.Fn.import_value("mre-program-table-name")
    ...
    def create_chalice_role(self):
        ...
        cdk.CfnOutput(self, "mre-program-api-url", value=self.chalice.sam_template.get_output("EndpointURL").value, description="MRE Program API Url", export_name="mre-program-api-url" )
