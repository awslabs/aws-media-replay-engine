...
class ChaliceApp(Stack):
    ...
    def create_chalice_role(self):
        ...
        CfnOutput(self, "mre-program-api-url", value=self.chalice.sam_template.get_output("EndpointURL").value, description="MRE Program API Url", export_name="mre-program-api-url" )
