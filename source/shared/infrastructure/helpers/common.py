...
class MreCdkCommon:
        ...
        mediaconvert_endpoints = cr.AwsCustomResource(
            ...
            policy=cr.AwsCustomResourcePolicy.from_statements(
                statements=[
                    iam.PolicyStatement(
                        ...
                        resources=[
                            f"arn:aws:mediaconvert:{Aws.REGION}:{Aws.ACCOUNT_ID}:*"
                        ],
                    )
                ]
            ),
            on_create=cr.AwsSdkCall(
                ...
                physical_resource_id=cr.PhysicalResourceId.of(
                    id="MediaConvertCustomResourceAwsSdkCall"
                ),
            ),
    ...
    def get_event_bus(this) -> events.IEventBus:
        ...
        return events.EventBus.from_event_bus_arn(
            this, "ImportedEventBus", Fn.import_value("mre-event-bus-arn")
        )
    ...
    def get_transitions_clips_bucket(this):
        return s3.Bucket.from_bucket_name(
            this,
            "MreTransitionsClipsBucketName",
            Fn.import_value("mre-transition-clips-bucket-name"),
        )
    ...
    def get_media_convert_output_bucket(this):
        return s3.Bucket.from_bucket_name(
            ...
            Fn.import_value("mre-media-output-bucket-name"),
        )
    ...
    def get_media_source_bucket(this):
        return s3.Bucket.from_bucket_name(
            this,
            "MreMediaSourceBucketName",
            Fn.import_value("mre-media-source-bucket-name"),
        )
    ...
    def get_segment_cache_bucket(this):
        return s3.Bucket.from_bucket_name(
            this,
            "MreSegmentCacheBucketName",
            Fn.import_value("mre-segment-cache-bucket-name"),
        )
    ...
    def get_powertools_layer_from_arn(this) -> ILayerVersion:
        return _lambda.LayerVersion.from_layer_version_arn(
            this,
            "PowerToolsLayerFromArn",
            f"arn:aws:lambda:{Aws.REGION}:017000801446:layer:AWSLambdaPowertoolsPythonV3-{PYTHON_VERSION}-x86_64:3",
        )

    @staticmethod
    def get_timecode_layer_from_arn(this) -> ILayerVersion:
        timecode_layer_arn = ssm.StringParameter.value_for_string_parameter(
            this, parameter_name="/MRE/TimecodeLambdaLayerArn"
        )
        return _lambda.LayerVersion.from_layer_version_arn(
            this, "TimeCodeLayerFromArn", timecode_layer_arn
        )

    @staticmethod
    def get_ffmpeg_layer_from_arn(this) -> ILayerVersion:
        ffmpeg_layer_arn = ssm.StringParameter.value_for_string_parameter(
            this, parameter_name="/MRE/FfmpegLambdaLayerArn"
        )
        return _lambda.LayerVersion.from_layer_version_arn(
            this, "ffmpegLayerFromArn", ffmpeg_layer_arn
        )

    @staticmethod
    def get_ffprobe_layer_from_arn(this) -> ILayerVersion:
        ffprobe_layer_arn = ssm.StringParameter.value_for_string_parameter(
            this, parameter_name="/MRE/FfprobeLambdaLayerArn"
        )
        return _lambda.LayerVersion.from_layer_version_arn(
            this, "ffprobeLayerFromArn", ffprobe_layer_arn
        )
    ...
    def get_mre_workflow_helper_layer_from_arn(this) -> ILayerVersion:
        mre_workflow_helper_layer_arn = ssm.StringParameter.value_for_string_parameter(
            this, parameter_name="/MRE/WorkflowHelperLambdaLayerArn"
        )
        return _lambda.LayerVersion.from_layer_version_arn(
            this, "workflowHelperLayerFromArn", mre_workflow_helper_layer_arn
        )
    ...
    def get_mre_plugin_helper_layer_from_arn(this) -> ILayerVersion:
        mre_plugin_helper_layer_arn = ssm.StringParameter.value_for_string_parameter(
            this, parameter_name="/MRE/PluginHelperLambdaLayerArn"
        )
        return _lambda.LayerVersion.from_layer_version_arn(
            this, "pluginHelperLayerFromArn", mre_plugin_helper_layer_arn
        )
    ...
    def get_mre_harvest_queue(this) -> sqs.IQueue:
        return sqs.Queue.from_queue_arn(
            this, "harvestQueueFromArn", Fn.import_value("mre-harvest-queue-arn")
        )
