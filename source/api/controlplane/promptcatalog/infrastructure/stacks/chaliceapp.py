...
class ChaliceApp(Stack):
    ...
    def create_chalice_role(self):
        ...
        self.chalice_role = iam.Role(
            ...
            description="Role used by the MRE Prompt Catalog API Lambda function",
        )
        ...
        self.chalice = Chalice(
            ...
            stage_config={
                "environment_variables": {
                    ...
                    "PROMPT_CATALOG_VERSION_INDEX": constants.PROMPT_CATALOG_VERSION_INDEX,
                    "PROMPT_CATALOG_NAME_INDEX": constants.PROMPT_CATALOG_NAME_INDEX,
                },
                "tags": {"Project": "MRE"},
        ...
        NagSuppressions.add_stack_suppressions(
            ...
            [
                ...
                },
                {
                    ...
                    "appliesTo": ["Resource::<PromptCatalogApiEnableLoggingHandlerFA26D7FC.Arn>:*"]
                }
            ],
        )
        ...
        CfnOutput(
            self,
            "mre-prompt-catalog-api-url",
            value=self.chalice.sam_template.get_output("EndpointURL").value,
            description="MRE Prompt Catalog API Url",
            export_name="mre-prompt-catalog-api-url",
        )
